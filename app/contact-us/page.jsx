            ...
            <div className="flex md:gap-[30px] md-max:gap-[50px] md-max:flex-col">
              <div className="md:basis-5/12 no-resize-text">
                ...
                <p className="indent__top">
                  Free Plumbing Estimate for any of our services, get to know
                  how to manage your current bookings online, get information
                  about our franchise opportunities, offer us a business
                  partnership or give feedback.
                </p>
                <ListEmail />
