...
const RequestQuote = () => (
  <>
    <div
      className={`${styles.section__indent_negative} container container__fluid-lg`}
    >
      <div className="sm:flex sm:gap-[30px] lg:gap-[40px] xl:gap-[65px] form__box">
        ...
        <div className={`${styles.col__img} sm-max:mt-[35px]`}>
          <div className={`${styles.form__img} relative`}>
            ...
            />
            <div
              className={`${styles.form__label} lazyload absolute`}
              data-bg="images/home__form-label_bg.png"
            >
              <div className={`${styles.form__label_icon} icon-1545289`}></div>
              <div className={`${styles.form__label_text1} font-bold`}>
                100%
              </div>
              <div className={`${styles.form__label_text2}`}>Happy Clients</div>
            </div>
          </div>
        </div>
      </div>
