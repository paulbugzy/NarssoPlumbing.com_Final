...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`${styles.header__wrapper} lock-padding`}
        id="js-header"
      >
        ...
        <div className={`${styles.hlayout} relative grid`} id="js-init-sticky">
          <Logo />
          <div
            className={`${styles.hlayout__col} ${styles.hlayout__corner} ${styles.hlayout__bg} relative flex items-center justify-center`}
          >
            <NavBar />
          </div>
          <div
            className={`${styles.hlayout__col} ${styles.hlayout__bg} ${styles.hlayout__objects} inline-flex items-center`}
          >
            <Telephone />
            <Button
