...
const infoBox = [
  {
    ...
    content: "Ready for a price? Schedule your Free Plumbing Estimate!",
    link: "#"
  },
  {
    id: 2,
    ...
    content: "Fan of hold music? Us either. Request us to call you instead.",
    link: "#"
  },
  {
    id: 3,
    ...
    content: "24/7 Emergency Plumbers Near You. We're ready to help!",
    link: "#"
  }
];
    ...
    <>
      ...
      >
        ...
        <div className={`${styles.toggleBar__logo_text}`}>
          Narsso Construction and Plumbing
        </div>
      </div>
      <p
        className={`toggleBar__objHidden_mobile relative ${styles.logo_popup_info}`}
      >
        We are a licensed, bonded, and insured plumbing company that offers
        full-service plumbing for residential, commercial, and 24-hour emergency
        plumbing projects. Our team is dedicated to providing high-quality
        workmanship and exceptional customer service. We stand behind our work
        and being rated 5-Stars says our clients do too with a 100% satisfaction
        guarantee.
      </p>
      <Button
      ...
      <div className={`${styles.toggleBar__item} relative`}>
        <div className="ttsubtitle">Contact us</div>
        <div className={`${styles.infoBox__wrapper}`}>
          {infoBox.map(({ id, icon, title, content, address, link }) => (
            <div
              key={id}
